...
<html lang="en">
  ...
  <body>
    ...
    <p>This result was processed on my EC2 instance with Public IP: <?= $_SERVER['SERVER_ADDR'] ?></p>
    <p>Access the application via Load Balancer URL: http://<?= $_SERVER['SERVER_NAME'] ?>/math_form.php</p>
